...
class EventTest < ActiveSupport::TestCase
  describe Event do
    ...
    it 'should require a unique unique_identifier for a given category' do
      event = events(:valid_fire)
      other_event = Event.new(category: event.category, unique_identifier: event.unique_identifier)
      other_event.valid?
